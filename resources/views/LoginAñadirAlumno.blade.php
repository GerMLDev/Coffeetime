...
<body class="bg-dark" style="padding-bottom: 5%; padding-top: 2%;" >
    ...
    <div class="container mt-5 bg-light p-4 rounded shadow" width="70%">
        <h2 class="text-center mb-4" style="background-color:green; color:white; padding: 10px;">Registrando nuevo usuario de alumno</h2>
        <hr>
        ...
        <form action="{{route('registroalumnologin')}}" method="post" class="bg-light p-4 rounded shadow-sm">
            @csrf
            <!-- Nombre -->
            <div class="mb-3">
