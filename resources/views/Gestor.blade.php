                    ...
                    <div class="d-grid gap-2 col-6 mx-auto">
                        ...
                        @if (auth()->user()->hasRole('admin'))
                            <form action="{{ route('agregarprofe') }}">
                                <button type="submit" class="btn btn-success w-100 mb-2">Añadir Profesor</button>
                            </form>
                            <form action="{{ route('gestionarprofe') }}">
                                <button type="submit" class="btn btn-warning w-100 text-white mb-2">Gestionar
                                    Profesores</button>
                            </form>
                        @endif
                        ...
                        @if (auth()->user()->hasRole('admin') || auth()->user()->hasRole('profesor'))
                            <form action="{{ route('dashboardProfesor') }}">
                                <button type="submit" class="btn btn-primary w-100 text-white">Alumnos registrados por
                                    Profesor</button>
                            </form>
                        @endif
                    </div>
                    ...
                    <div class="card shadow-sm p-4">
                        ...
                        <div class="d-grid gap-2 col-6 mx-auto">
                            <form action="{{ route('api') }}">
                                <button type="submit" class="btn btn-info w-100 text-white">API - Listado
                                    de usuarios</button>
                            </form>
                            ...
                            <form action="{{ route('gestionarusuario') }}">
                                <button type="submit" class="btn btn-warning w-100 text-white">Gestionar
                                    Usuarios</button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="card shadow-sm p-4">
                        ...
                        <div class="d-grid gap-2 col-6 mx-auto">
                            ...
                            <form action="{{ route('dashboardNivel') }}">
                                <button type="submit" class="btn btn-primary w-100 text-white">Alumnos registrados
                                    por
                                    Nivel</button>
                            </form>
                        </div>
